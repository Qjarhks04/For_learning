...
# embed16=discord.Embed(title="백석대학교 학사일정", url="https://www.bu.ac.kr/web/3443/subview.do?enc=Zm5jdDF8QEB8JTJGdG90YWxTY2hkdWwlMkZ3ZWIlMkZ2aWV3LmRvJTNG", color=0x243cb2)
# embed16.set_thumbnail(url="https://www.bu.ac.kr/sites/web/images/logo_w.png")
# embed16.add_field(name="01.01 (월)", value="신정", inline=True)
# embed16.add_field(name="01.02 (화) ~ 01.05 (금)", value="2학기 성적열람", inline=True)
# embed16.add_field(name="01.02 (화) ~ 01.12 (금)", value="2024-1학기 재입학 신청기간", inline=True)
# embed16.add_field(name="01.05 (금)", value="2학기 성적마감 확정", inline=True)
# embed16.add_field(name="01.12 (금) ~ 01.16 (화)", value="가군 정시 면접.실기고사", inline=True)
# embed16.add_field(name="01.15 (월) ~ 01.26 (금)", value="2024-1학기 복학신청 기간", inline=True)
# embed16.add_field(name="01.18 (목) ~ 01.22 (월)", value="동계 계절학기 성적입력", inline=True)
# embed16.add_field(name="01.22 (월) ~ 01.24 (수)", value="동계 계절학기 성적열람", inline=True)
# embed16.add_field(name="01.22 (월) ~ 01.24 (수)", value="나군 정시 면접.실기고사", inline=True)
# embed16.add_field(name="01.24 (수)", value="동계 계절학기 성적마감", inline=True)
# embed16.set_footer(text="Python Bot")

# embed17=discord.Embed(title="백석대학교 학사일정", url="https://www.bu.ac.kr/web/3443/subview.do?enc=Zm5jdDF8QEB8JTJGdG90YWxTY2hkdWwlMkZ3ZWIlMkZ2aWV3LmRvJTNG", color=0x243cb2)
# embed17.set_thumbnail(url="https://www.bu.ac.kr/sites/web/images/logo_w.png")
# embed17.add_field(name="02.05 (월) ~ 02.08 (목)", value="2024-1학기 수강신청(재학, 복학, 재입학생)", inline=True)
# embed17.add_field(name="02.09 (금) ~ 02.11 (일)", value="설날연휴", inline=True)
# embed17.add_field(name="02.15 (목)", value="2023학년도 전기 학위수여식", inline=True)
# embed17.add_field(name="02.19 (월) ~ 02.23 (금)", value="조기졸업신청기간", inline=True)
# embed17.add_field(name="02.21 (수)", value="2024학년도 신입생 입학식 및 대학생활안내", inline=True)
# embed17.add_field(name="02.22 (목) ~ 02.23 (금)", value="2024-1학기 수강신청(신, 편입생)", inline=True)
# embed17.add_field(name="02.23 (금) ~ 02.29 (목)", value="재학생 등록기간", inline=True)
# embed17.add_field(name="02.26 (월) ~ 03.08 (금)", value="졸업이수학점 확인기간", inline=True)
# embed17.add_field(name="02.26 (월) ~ 03.08 (금)", value="수강신청 정정기간(전체)", inline=True)
# embed17.add_field(name="02.27 (화)", value="교원상견례 및 연수", inline=True)
# embed17.set_footer(text="Python Bot")